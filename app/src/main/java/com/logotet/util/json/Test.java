 ...
 * It is just a casual testiranje tool.
 */
public class Test {
 ...
 */
        ...
        try {     
            j = XML.toJSONObject("<![CDATA[This is a collection of testiranje patterns and examples for org.json.]]>  Ignore the stuff past the end.  ");
            ...
            j = XML.toJSONObject("<testiranje intertag status=ok><empty/>deluxe<blip sweet=true>&amp;&quot;toot&quot;&toot;&#x41;</blip><x>eks</x><w>bonus</w><w>bonus2</w></testiranje>");
            System.out.println(j.toString(2));
            System.out.println(XML.toString(j));
            System.out.println("");
            ...
            JSONTokener jt = new JSONTokener("{op:'testiranje', to:'session', pre:1}{op:'testiranje', to:'session', pre:2}");
            j = new JSONObject(jt);
            System.out.println(j.toString());
